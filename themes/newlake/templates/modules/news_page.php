...
<div class="section-standard">
    <div class="standard-box news-page-standard-box">
        <?php if($title) : ?>
        <div class="line-break"></div><h2><?php echo $title; ?></h2><?php endif; ?>
...
if ( $query->have_posts() ) {
    while ( $query->have_posts() ) {
        ...
        <a href="<?php echo the_permalink(); ?>" class="benefit-flex news-flex" target="_blank">
            ...
            <?php echo '<div style="background: url(';
...
<?php 
    ...
    } echo '</div><div class="line-break"></div>';
